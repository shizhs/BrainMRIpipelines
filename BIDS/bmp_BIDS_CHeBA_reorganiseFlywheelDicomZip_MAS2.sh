...
deal_with_3D $DICOM_zip $BIDS_dir $subject_ID "/t2_space_dark-fluid_sag_p2_ns-t2prep new/"										FLAIR
...
case "$subject_ID" in
	*)
		deal_with_3D $DICOM_zip $BIDS_dir $subject_ID "/greME9_p31_256_Iso1mm_new_Qsm/"								SWI_QSM
		deal_with_3D $DICOM_zip $BIDS_dir $subject_ID "/greME9_p31_256_Iso1mm_new_SWI_Combined/"					SWI_SWI
		deal_with_4D $DICOM_zip $BIDS_dir $subject_ID "/greME9_p31_256_Iso1mm_new_Mag/"								SWI_mag
		deal_with_4D $DICOM_zip $BIDS_dir $subject_ID "/greME9_p31_256_Iso1mm_new_Pha/"								SWI_pha
		;;	
esac
